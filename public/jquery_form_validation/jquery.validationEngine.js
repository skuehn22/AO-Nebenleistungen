 ...
 * Examples: http://www.position-relative.net/creation/formValidator/
 * Quelle: https://github.com/posabsolute/jQuery-Validation-Engine
 *
    ...
    var methods = {
        ...
        _buildPrompt: function(field, promptText, type, ajaxed, options) {
            ...
            if (options.showArrow) {
				...
				var myField = field[0].id;
				var myPosition = $("#" + myField).attr("position");
				if(!myPosition)
					myPosition = options.promptPosition;
        ...
        _calculatePosition: function(field, promptElmt, options) {
            ...
            switch (myPosition) {
                ...
                case "centerRight":
                    ...
                    break;
                case "bottomLeft":
                    promptTopPosition = promptTopPosition + field.height();
                    break;
                case "bottomRight":
                    promptleftPosition += fieldWidth - 30;
