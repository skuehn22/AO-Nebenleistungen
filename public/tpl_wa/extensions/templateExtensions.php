 ...
 * wird ein 'Leerbild' angezeigt.
 * Es wirden die Zusatzinformationen des
 * Bildes ermittelt. Ein kompletter <img Tag wird
 * zurückgegeben.
 *
 * @param $bildId ID des Bildes
 * @param $__bild Bereich 1 = Programme, 6 = Hotel, 10 = Stadt
 * @param $__bild Groesse Anzuzeigende Bildbreite
 */
function anzeigenBilder($bildId, $bildTyp, $bildBreite = 0, $copyrightAlign = 0)
{
