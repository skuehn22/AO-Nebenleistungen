...
function fillTemplate(sprache){
    ...
    if(sprache == '1')
        var titel = 'deutsche Beschreibung, ID: ' + programmNummer + ', Programmanme: ' + programmName;
    else
        var titel = 'englische Beschreibung, ID: ' + programmNummer + ', Programmanme: ' + programmName;
