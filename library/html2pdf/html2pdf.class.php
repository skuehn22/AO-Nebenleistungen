...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/class/exception.class.php');
    require_once(dirname(__FILE__).'/class/locale.class.php');
    require_once(dirname(__FILE__).'/class/myPdf.class.php');
    require_once(dirname(__FILE__).'/class/parsingHtml.class.php');
    require_once(dirname(__FILE__).'/class/parsingCss.class.php');
