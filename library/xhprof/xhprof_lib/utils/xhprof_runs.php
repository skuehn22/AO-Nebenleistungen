...
class XHProfRuns_Default implements iXHProfRuns {
  ...
  {
      if(!empty($dir) and is_array($dir))
          $this->_xhprofConf = $dir;
  ...
  {
    if(!empty($this->_xhprofConf))
        $_xhprof = $this->_xhprofConf;
    else
	    global $_xhprof;

	require_once XHPROF_LIB_ROOT.'/utils/Db/Mysqli.php';
