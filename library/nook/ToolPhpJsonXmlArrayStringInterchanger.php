<?php
/**
 * Tool zum konvertieren von Json oder XML in ein Array
 *
 * @author Stephan Krauss
 * @date 30.05.2014
 * @file ToolPhpJsonXmlArrayStringInterchanger.php
 * @project HOB
 * @package tool
 */
 class nook_ToolPhpJsonXmlArrayStringInterchanger
 {
     ...
     /**
      * Gibt einen Flag zurück, ob Fehler aufgetreten sind
      *
      * @return bool
      */
     public function getFlagErrors()
     {
         $flagErrors = false;
